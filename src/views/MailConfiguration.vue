    ...
    <div class="container mt-4 p-4 border rounded bg-white">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" v-model="form.mail_driver" class="form-control" placeholder="smtp" />
            </div>

            <!-- Mail Host -->
            <div class="col-md-4 mb-3">
                <label for="mailHost" class="form-label">Mail Host</label>
                <input type="text" v-model="form.mail_host" class="form-control" placeholder="test.smtp.com" />
            </div>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" name="mailFromAddress" placeholder="Add multiple addresses separated by commas."
                    v-model="mailFromAddressInput" />
            </div>

            <!-- Mail From Name -->
            <div class="col-md-4 mb-3">
                <label for="mailFromName" class="form-label">Mail From Name</label>
                <input type="text" v-model="form.mail_from_name" class="form-control" placeholder="Workdo-Dash" />
            </div>
